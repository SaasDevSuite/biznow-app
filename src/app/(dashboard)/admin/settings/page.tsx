                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={settings.timezone}
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="utc+10">Australian Eastern Standard Time
                                            (UTC+10)</SelectItem>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <Checkbox
                                            ...
                                            onChange={(e: any) => updateNotificationSettings({
                                                ...settings.notifications,
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => updateNotificationSettings({
                                        ...settings.notifications,
                                        frequency: value as "real-time" | "daily" | "weekly"
                                    })}
                                >
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-2">
                                        <p className="text-sm text-muted-foreground">Connected: Google Analytics,
                                            Facebook Pixel</p>
