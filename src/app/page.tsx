...
import {ArrowRight, BarChart3, CheckCircle, Clock, Newspaper, Shield, TrendingUp, Zap} from "lucide-react"
        ...
        <div className="min-h-screen flex flex-col overflow-x-hidden relative">
            ...
            <main>
                ...
                <section className="relative py-20 px-4 overflow-hidden">
                    {/* Background gradient */}
                    <div
                        className="absolute inset-0 bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-blue-950/20 dark:via-background dark:to-purple-950/20"/>
                    ...
                    <div className="container mx-auto text-center max-w-4xl relative z-10">
                        ...
                        >
                            Transform raw business news into actionable insights with our AI-powered platform. Get
                            real-time sentiment
                            ...
                            >
                                {isLoading ? (
                                    ...
                                    displayNews.map((news) => (
                                        ...
                                        >
                                            <Card
                                                className="h-full flex flex-col border-2 hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-300 bg-gradient-to-br from-white to-blue-50/30 dark:from-background dark:to-blue-950/30">
                                                <CardHeader>
                                                    ...
                                                    <CardTitle
                                                        className="text-xl mt-2 line-clamp-2">{news.title}</CardTitle>
                            ...
                            >
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        description: "Round-the-clock market surveillance"
                                    },
                                ].map((feature, index) => (
                                    <motion.div
                                        key={index}
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                                        Join thousands of professionals who rely on Biznow for critical business
                                        intelligence.
                                    </p>
                                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                        ...
                                        <motion.div whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}>
                                            <Button
                                                ...
                                                size="lg"
                                                variant="outline"
                                                className="text-lg px-8 py-6 border-white/20 text-white hover:bg-white/10 dark:text-white dark:border-white/20 dark:hover:bg-white/10 bg-blue-600/10"
                                            >
                                                <Link href="/company-pages/contact">Contact Sales</Link>
                                            </Button>
                                        </motion.div>
                                    </div>
            ...
            >
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        <div className="md:col-span-2">
                            ...
                            <p className="text-muted-foreground mb-4 max-w-md">
                                Business news analytics that keeps you ahead of the market. Transform information into
                                intelligence with
                                AI-powered insights.
                            </p>
                        </div>
                        <div className="md:col-start-4">
                            ...
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                <li>
                                    <Link href="/company-pages/about-us"
                                          className="hover:text-primary transition-colors">
                                        About
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/company-pages/contact"
                                          className="hover:text-primary transition-colors">
                                        Contact
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/company-pages/terms" className="hover:text-primary transition-colors">
                                        Terms
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/company-pages/privacy-policy"
                                          className="hover:text-primary transition-colors">
                                        Privacy Policy
                                    </Link>
                                </li>
                    ...
                    <div className="border-t pt-8 flex flex-col md:flex-row justify-center items-center">
                        <div className="text-sm text-muted-foreground mb-4 md:mb-0 text-center">
