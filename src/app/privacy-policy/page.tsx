...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
      {/* Background grid pattern using inline styles instead of globals.css */}
      <div
        ...
        <div className="p-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                We collect minimal user data such as email, news preferences, and usage metrics to improve the platform and provide personalized business intelligence.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                We connect to external AI providers (e.g., Hugging Face) for news analysis. Your data is securely routed through these APIs.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                All data is encrypted in transit using industry standards (TLS). Stored data is protected using secure access controls. We do not sell your data.
              </p>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-muted-foreground">
              ...
              <a href="mailto:dewmal@syigen.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                privacy@syigen.com
              </a>
            </p>
          </div>
